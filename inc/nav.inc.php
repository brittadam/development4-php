        ...
        <div class="mt-1">
            <div class="mt-2 mr-5 ml-2 relative bottom-[2px] flex flex-row-reverse">
                ...
                <?php if (isset($_SESSION['loggedin'])) : ?>
                    ...
                    <p class="bg-[#BB86FC] text-center text-white font-bold rounded w-50 sm:py-1 sm:px-2 md:px-5 mr-2 xl:mr-5 relative bottom-1">credits <?php Echo Promptopolis\Framework\User::getCredits($_SESSION['id']) ?></p>
